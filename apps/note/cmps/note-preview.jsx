            ...
            {/* {note.type === 'NoteImg' && <NoteImg note={note} />} */}
                ...
                <ul>
                    <li className="flex row">
                        <button className="edit-note" onClick={() => onEditNote(note.id)} ><img src="./assets/img/imgs-notes/edit.svg" alt="Edit Note" /></button>
                        <button className="mail-send" onClick={() => onSendMail(note.id)} ><img src="./assets/img/imgs-gmail/mail.svg" alt="Mail" /></button>
                        <button className="palette-color" onClick={() => onChangeBgc(note.id)} ><img src="./assets/img/imgs-notes/color-palette.svg" alt="Color Palette" /></button>
